...
FROM (
  VALUES
    ...
    ('Tartare de Saumon', 'Saumon cru citronné finement taillé, touche d''huile d''olive.', 7000, 'https://images.unsplash.com/photo-1656106577512-0259bf5b9fd6?auto=format&fit=crop&w=800&q=70', 'entrees-salades', NULL, true, ARRAY['poissons'], false, '8f7c1bf8-feb5-4f34-88fb-781f2fd89d55'::uuid, false),
