      ...
      <section className="relative isolate overflow-hidden">
        ...
        <div className="mx-auto flex min-h-[72vh] w-full max-w-7xl flex-col items-center justify-center px-4 py-20 text-center md:px-6">
          ...
          <img
            ...
            alt="L'Aura Lounge"
            className="w-[min(74vw,460px)] max-w-full drop-shadow-[0_2px_20px_rgba(0,0,0,0.4)]"
          />
          <p className="mt-3 font-logo text-sm uppercase tracking-[0.4em] text-[var(--color-cream)]/85">
            Lounge
          </p>
